...
**The public availability calendar (A1)** is a different component from the range picker above and from the portal's booking calendar below — it carries per-night price and availability — and must be specified here before it is built.
