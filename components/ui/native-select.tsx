 ...
 * Treatment matches Input: white, neutral hairline, 6px, `body-md`, ink focus
  ...
  return (
    <div className={cn('relative', className)}>
      <select
        ...
        className="h-control w-full cursor-pointer appearance-none rounded-md border border-border bg-card pr-2xl pl-md text-body-md text-foreground transition-[border-color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/10 disabled:cursor-not-allowed disabled:opacity-50"
        {...props}
      />
      <ChevronDown
        aria-hidden
